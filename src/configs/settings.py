...
class Settings(BaseSettings):
    ...
    Data Paths
        ...
        UNSEEN_DATA_DIR : Path
            Directory for inference-time datasets.
        PREPROCESSED_DATA_DIR : Path
            Directory for processed datasets.

    Artifacts & Reports
        EXP_ARTIFACT_DIR : Path
            Location of experiment-generated artifacts.
        ARTIFACTS_DIR : Path
            Run-specific artifact output directory.
    ...
    EXP_ARTIFACT_DIR: Path = BASE_DIR / "src" / "experiments" / "artifacts"
