...
class Settings(BaseSettings):
    ...
    # Contains raw dataset with features and target
    RAW_DATA_DIR: Path = BASE_DIR / "data" / "raw"
    RAW_DATA_FILENAME: str = "raw_data.csv"

    # Contains dataset with features only
    UNSEEN_DATA_DIR: Path = BASE_DIR / "data" / "unseen"
    UNSEEN_DATA_FILENAME: str = "unseen_data.csv"

    # Preprocessed dataset for main pipeline
    PREPROCESSED_DATA_DIR: Path = BASE_DIR / "data" / "processed"
    PREPROCESSED_DATA_FILENAME: str = "processed_data.parquet"

    # Preprocessed dataset for experiment notebooks
    EXPERIMENTS_DATA_DIR: Path = BASE_DIR / "data" / "experiments"
    LINEAR_TRAIN_FILENAME: str = "linear_train_data.parquet"
    LINEAR_TEST_FILENAME: str = "linear_test_data.parquet"
    LINEAR_FILENAME: str = "linear_data.parquet"
    TREE_TRAIN_FILENAME: str = "tree_train_data.parquet"
    TREE_TEST_FILENAME: str = "tree_test_data.parquet"
    TREE_FILENAME: str = "tree_data.parquet"
    ...
    # Artifacts generated by experiment notebooks
    EXP_ARTIFACT_DIR: Path = BASE_DIR / "transformers"
    PREPROCESS_PIPELINE_FILENAME: str = "preprocessor_pipeline.joblib"
    TARGET_ENCODER_FILENAME: str = "target_encoder.joblib"
